...
import { Home, Tv2, FileSignature, BookText, FileText, Layers3, CalendarDays, ListChecks, Megaphone, Share2, ListOrdered, Gauge, ClipboardCheck, ClipboardList, BadgeCheck, GitPullRequestArrow, Table2, LayoutDashboard, ShieldCheck, Radio, Coins, BarChart3, Settings } from 'lucide-react'
...
export const SECTIONS = [
  ...
  { id: 'SYNOPSIS_FR', label: 'Rédaction du synopsis — FR', icone: FileText },
  { id: 'SYNOPSIS_AR', label: 'Rédaction du synopsis — AR', icone: FileText },
  ...
  { id: 'RAPPORT_VOLUME', label: 'Volume horaire', icone: BarChart3 },
